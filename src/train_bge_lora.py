...
from utils import (
  ...
  BGE_QUERY_PREFIX,
  TEACHER_NAME,
  SPECIAL_TOKS as _SPECIAL_TOKS,
  EVAL_K,
  BGE_TRAIN_QUERY_MAX_LEN as QUERY_MAX_LEN,
  BGE_TRAIN_DOC_MAX_LEN as DOC_MAX_LEN,
  BGE_TRAIN_BATCH_SIZE as BATCH_SIZE,
  BGE_TRAIN_GRAD_ACCUM as GRAD_ACCUM,
  BGE_TRAIN_NUM_HARD_NEG as NUM_HARD_NEG,
  BGE_TRAIN_NUM_RAND_NEG as NUM_RAND_NEG,
  BGE_TRAIN_LR as LR,
  BGE_TRAIN_WEIGHT_DECAY as WEIGHT_DECAY,
  BGE_TRAIN_WARMUP_RATIO as WARMUP_RATIO,
  BGE_TRAIN_EPOCHS as EPOCHS,
  BGE_TRAIN_PATIENCE as PATIENCE,
  BGE_TRAIN_GRAD_CLIP as GRAD_CLIP,
  BGE_TRAIN_TEMP as TEMP,
  BGE_TRAIN_TEACHER_TEMP as TEACHER_TEMP,
  BGE_TRAIN_KL_WEIGHT as KL_WEIGHT,
  BGE_TRAIN_REMINE_EVERY as REMINE_EVERY,
  BGE_TRAIN_NUM_WORKERS as NUM_WORKERS,
  BGE_TRAIN_CHECKPOINT_DIR as CHECKPOINT_DIR,
  BGE_TRAIN_TEACHER_MAX_LEN as TEACHER_MAX_LEN,
  BGE_TRAIN_TEACHER_CHUNK as TEACHER_CHUNK,
  BGE_TRAIN_RERANK_POOL as RERANK_POOL,
)
